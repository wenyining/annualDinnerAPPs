/*!Copyright(c) CommentCoreLibrary (//github.com/jabbany/CommentCoreLibrary) - Licensed under the MIT License */function CommentFilter() {
    this.modifiers = [], this.runtime = null, this.allowTypes = {1: !0, 4: !0, 5: !0, 6: !0, 7: !0, 8: !0, 17: !0}, this.doModify = function (a) {
        for (var b = 0; b < this.modifiers.length; b++)
            a = this.modifiers[b](a);
        return a
    ...
    for (var e = 0; e < c.length; e++) {
        ...
        if (g.length > 0) {
            if (f.stime = 1e3 * parseFloat(g[0]), f.color = parseInt(g[1]), f.mode = parseInt(g[2]), f.size = parseInt(g[3]), f.hash = g[4], f.date = parseInt(g[5]), f.position = "absolute", 7 != f.mode ? (f.text = c[e].m.replace(/(\/n|\\n|\n|\r\n|\\r)/g, "\n"), f.text = f.text.replace(/\r/g, "\n"), f.text = f.text.replace(/\s/g, " ")) : f.text = c[e].m, 7 == f.mode) {
                ...
                if (f.position = "relative", f.text = h.n, f.text = f.text.replace(/\ /g, " "), f.opacity = null != h.a ? h.a : 1, null != h.p ? (f.x = h.p.x / 1e3, f.y = h.p.y / 1e3) : (f.x = 0, f.y = 0), f.shadow = h.b, f.dur = 4e3, null != h.l && (f.moveDelay = 1e3 * h.l), null != h.z && h.z.length > 0) {
                    f.movable = !0, f.motion = [];
                    for (var i = 0, j = {x: f.x, y: f.y, alpha: f.opacity, color: f.color}, k = 0; k < h.z.length; k++) {
                        var l = null != h.z[k].l ? 1e3 * h.z[k].l : 500;
                        i += l;
                        var m = {x: {from: j.x, to: h.z[k].x / 1e3, dur: l, delay: 0}, y: {from: j.y, to: h.z[k].y / 1e3, dur: l, delay: 0}};
                        j.x = m.x.to, j.y = m.y.to, h.z[k].t !== j.alpha && (m.alpha = {from: j.alpha, to: h.z[k].t, dur: l, delay: 0}, j.alpha = m.alpha.to), null != h.z[k].c && h.z[k].c !== j.color && (m.color = {from: j.color, to: h.z[k].c, dur: l, delay: 0}, j.color = m.color.to), f.motion.push(m)
                    }
...
function BilibiliParser(a, b, c) {
    ...
    if (null !== a)
        ...
        if (c) {
            ...
            b = b.replace(new RegExp("</([^d])", "g"), "</disabled $1"), b = b.replace(new RegExp("</(S{2,})", "g"), "</disabled $1"), b = b.replace(new RegExp("<([^d/]W*?)", "g"), "<disabled $1"), b = b.replace(new RegExp("<([^/ ]{2,}W*?)", "g"), "<disabled $1");
        var f = document.createElement("div");
        f.innerHTML = b;
        var e = f.getElementsByTagName("d")
    }
    for (var g = [], h = 0; h < e.length; h++)
        if (null != e[h].getAttribute("p")) {
            var i = e[h].getAttribute("p").split(",");
            if (!e[h].childNodes[0])
                continue;
            var b = e[h].childNodes[0].nodeValue, j = {};
            if (j.stime = Math.round(1e3 * parseFloat(i[0])), j.size = parseInt(i[2]), j.color = parseInt(i[3]), j.mode = parseInt(i[1]), j.date = parseInt(i[4]), j.pool = parseInt(i[5]), j.position = "absolute", null != i[7] && (j.dbid = parseInt(i[7])), j.hash = i[6], j.border = !1, j.mode < 7)
                j.text = b.replace(/(\/n|\\n|\n|\r\n)/g, "\n");
            else if (7 == j.mode)
                try {
                    if (adv = JSON.parse(d(b)), j.shadow = !0, j.x = parseFloat(adv[0]), j.y = parseFloat(adv[1]), (Math.floor(j.x) < j.x || Math.floor(j.y) < j.y) && (j.position = "relative"), j.text = adv[4].replace(/(\/n|\\n|\n|\r\n)/g, "\n"), j.rZ = 0, j.rY = 0, adv.length >= 7 && (j.rZ = parseInt(adv[5], 10), j.rY = parseInt(adv[6], 10)), j.motion = [], j.movable = !1, adv.length >= 11) {
                        j.movable = !0;
                        var k = 500, l = {x: {from: j.x, to: parseFloat(adv[7]), dur: k, delay: 0}, y: {from: j.y, to: parseFloat(adv[8]), dur: k, delay: 0}};
                        if ("" !== adv[9] && (k = parseInt(adv[9], 10), l.x.dur = k, l.y.dur = k), "" !== adv[10] && (l.x.delay = parseInt(adv[10], 10), l.y.delay = parseInt(adv[10], 10)), adv.length > 11 && (j.shadow = adv[11], "true" === j.shadow && (j.shadow = !0), "false" === j.shadow && (j.shadow = !1), null != adv[12] && (j.font = adv[12]), adv.length > 14)) {
                            ...
                            for (var m = adv[14], n = {x: l.x.from, y: l.y.from}, o = [], p = new RegExp("([a-zA-Z])\\s*(\\d+)[, ](\\d+)", "g"), q = m.split(/[a-zA-Z]/).length - 1, r = p.exec(m); null !== r; ) {
                                switch (r[1]) {
                                    case"M":
                                        n.x = parseInt(r[2], 10), n.y = parseInt(r[3], 10);
                                        break;
                                    case"L":
                                        o.push({x: {from: n.x, to: parseInt(r[2], 10), dur: k / q, delay: 0}, y: {from: n.y, to: parseInt(r[3], 10), dur: k / q, delay: 0}}), n.x = parseInt(r[2], 10), n.y = parseInt(r[3], 10)
                                }
                                r = p.exec(m)
                            }
                            l = null, j.motion = o
...
var BinArray = function () {
    ...
    return a.bsearch = function (a, b, c) {
        ...
        if (c(b, a[0]) < 0)
            return 0;
        if (c(b, a[a.length - 1]) >= 0)
            return a.length;
        for (var d = 0, e = 0, f = 0, g = a.length - 1; g >= d; ) {
            if (e = Math.floor((g + d + 1) / 2), f++, c(b, a[e - 1]) >= 0 && c(b, a[e]) < 0)
                return e;
    ...
    return a.prototype.willCollide = function (a, b) {
        ...
        for (var d = a + b.height, e = b.right, f = 0; f < c.length; f++)
            if (!(c[f].y > d || c[f].bottom < a)) {
                if (!(c[f].right < b.x || c[f].x > e))
                    return!1;
                if (this.willCollide(c[f], b))
                    return!1
            }
        return!0
    }, a.prototype.assign = function (a, b) {
        for (; this._pools.length <= b; )
            this._pools.push([]);
        var c = this._pools[b];
        if (0 === c.length)
            return a.cindex = b, 0;
        if (this.pathCheck(0, a, c))
            return a.cindex = b, 0;
        for (var d = 0, e = 0; e < c.length && (d = c[e].bottom + this.avoid, !(d + a.height > this._height)); e++)
            if (this.pathCheck(d, a, c))
                return a.cindex = b, d;
        ...
        if (!(a.cindex < 0)) {
            if (a.cindex >= this._pools.length)
    ...
    return __extends(b, a), b.prototype.add = function (b) {
        ...
        for (var d = a + b.height, e = 0; e < c.length; e++)
            if (!(c[e].y > d || c[e].bottom < a))
                return!1;
        return!0
    }, b
    ...
    function a(b, c) {
        if ("undefined" == typeof c && (c = {}), this.mode = 1, this.stime = 0, this.text = "", this.ttl = 4e3, this.dur = 4e3, this.cindex = -1, this.motion = [], this.movable = !0, this._alphaMotion = null, this.absolute = !0, this.align = 0, this._alpha = 1, this._size = 25, this._color = 16777215, this._border = !1, this._shadow = !0, this._font = "", !b)
    ...
    return a.prototype.init = function (a) {
        ...
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "y", {get: function () {
        ...
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "width", {get: function () {
        ...
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "size", {get: function () {
            return this._size
        }, set: function (a) {
            this._size = a, this.dom.style.fontSize = this._size + "px"
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "color", {get: function () {
            return this._color
        }, set: function (a) {
            this._color = a;
            var b = a.toString(16);
        ...
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "alpha", {get: function () {
            return this._alpha
        }, set: function (a) {
            this._alpha = a, this.dom.style.opacity = Math.min(this._alpha, this.parent.options.global.opacity) + ""
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "border", {get: function () {
            return this._border
        }, set: function (a) {
            this._border = a, this.dom.style.border = this._border ? "1px solid #00ffff" : "none"
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "shadow", {get: function () {
            return this._shadow
        }, set: function (a) {
            this._shadow = a, this._shadow || (this.dom.className = this.parent.options.global.className + " noshadow")
        }, enumerable: !0, configurable: !0}), Object.defineProperty(a.prototype, "font", {get: function () {
            return this._font
        }, set: function (a) {
            this._font = a, this.dom.style.fontFamily = this._font.length > 0 ? this._font : ""
        }, enumerable: !0, configurable: !0}), a.prototype.time = function (a) {
    ...
    return __extends(b, a), Object.defineProperty(b.prototype, "alpha", {set: function (a) {
        ...
        }, enumerable: !0, configurable: !0}), b.prototype.init = function (b) {
    ...
    var b = function (a, b) {
        for (var c = Math.PI / 180, d = a * c, e = b * c, f = Math.cos, g = Math.sin, h = [f(d) * f(e), f(d) * g(e), g(d), 0, -g(e), f(e), 0, 0, -g(d) * f(e), -g(d) * g(e), f(d), 0, 0, 0, 0, 1], i = 0; i < h.length; i++)
            Math.abs(h[i]) < 1e-6 && (h[i] = 0);
    ...
    return a.prototype.stop = function () {
        ...
        if (a -= 1, this.position >= this.timeline.length || Math.abs(this.lastPos - a) >= 2e3) {
            if (this.seek(a), this.lastPos = a, this.timeline.length <= this.position)
                return
        } else
            this.lastPos = a;
        for (; this.position < this.timeline.length && !(this.options.limit > 0 && this.runline.length > this.limiter) && (this.validate(this.timeline[this.position]) && this.timeline[this.position].stime <= a); this.position++)
            this.send(this.timeline[this.position])
    }, a.prototype.rescale = function () {
    }, a.prototype.send = function (a) {
        if (8 === a.mode)
            return console.log(a), void(this.scripting && console.log(this.scripting.eval(a.code)));
        if (null == this.filter || (a = this.filter.doModify(a), null != a)) {
            if (1 === a.mode || 2 === a.mode || 6 === a.mode)
                var c = new ScrollComment(this, a);
            else
                var c = new CoreComment(this, a);
            switch (c.mode) {
                case 1:
                    c.align = 0;
                    break;
        ...
        if ("undefined" != typeof this._listeners[a])
